...
docs/orchestration/interaction/VisionAir.2_interaction_architecture_prompt.md
...
- docs/orchestration/core/VisionAir.1_core_intelligence_architecture.md
- docs/orchestration/governance/AlignFlow.1_structural_development_architecture.md
- docs/orchestration/governance/AROD.1_realism_and_validation_architecture.md
- docs/orchestration/governance/AMO.1_orchestration_and_continuation_architecture.md
...
docs/orchestration/interaction/VisionAir.2_interaction_architecture.md
...
Define VisionAir.2 as the layer that converts VisionAir's core intelligence into a usable, legible, interactive product experience.
...
Explicitly state what VisionAir.2 does NOT define.
...
and briefly state that it should translate VisionAir.2 into:
...
3. one-sentence statement of what VisionAir.2 adds beyond VisionAir.1
